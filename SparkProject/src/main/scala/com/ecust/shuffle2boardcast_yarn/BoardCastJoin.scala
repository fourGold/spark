package com.ecust.shuffle2boardcast_yarn
...
object BoardCastJoin {
  def main(args: Array[String]): Unit = {
    ...
    val order: RDD[String] = sc.textFile("hdfs://hadoop102/input/order.txt")
    val pd: RDD[String] = sc.textFile("hdfs://hadoop102/input/pd.txt")
